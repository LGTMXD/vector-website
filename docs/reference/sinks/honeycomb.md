...
[Honeycomb][urls.honeycomb] via the [batch events API][urls.honeycomb_batch].
...
The `honeycomb` sink buffers & batches data as
...
[urls.new_honeycomb_sink_issue]: https://github.com/timberio/vector/issues/new?labels=sink%3A+honeycomb
