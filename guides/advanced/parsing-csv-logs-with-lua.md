...
This guide walks through reading CSV logs using [`file`][docs.reference.sources.file] source and parsing them using
[`lua`][docs.reference.transforms.lua] transform with a loadable Lua module.
...
[`console`][docs.reference.sinks.console] sink.
...
[`source`][docs.reference.transforms.lua#source] configuration section:
