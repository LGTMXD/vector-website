...
description: "A simple guide to send logs from Journald to an HTTP endpoint in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [an HTTP endpoint][urls.http]
...
<!--
    ...
    guides/integrate/sources/journald/http.md.erb
-->
