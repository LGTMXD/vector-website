...
cover_label: "Journald to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: splunk_hec"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [a Splunk HEC][urls.splunk_hec]
...
<!--
    ...
    guides/integrate/sources/journald/splunk_hec.md.erb
-->
