...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [GCP Stackdriver][urls.gcp_stackdriver]
...
<!--
    ...
    guides/integrate/sources/journald/gcp_stackdriver_logs.md.erb
-->
