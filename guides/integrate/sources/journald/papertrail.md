...
description: "A simple guide to send logs from Journald to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [Papertrail][urls.papertrail]
...
<!--
     ...
     guides/integrate/sources/journald/papertrail.md.erb
-->
