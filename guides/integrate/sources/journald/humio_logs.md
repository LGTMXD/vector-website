...
description: "A simple guide to send logs from Journald to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Humio Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: humio_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [Humio][urls.humio]
...
<!--
    ...
    guides/integrate/sources/journald/humio_logs.md.erb
-->
