...
description: "A simple guide to send logs from Journald to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to InfluxDB Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: influxdb_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [InfluxDB][urls.influxdb]
...
<!--
    ...
    guides/integrate/sources/journald/influxdb_logs.md.erb
-->
