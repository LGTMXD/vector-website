...
cover_label: "Journald to Honeycomb Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [Honeycomb][urls.honeycomb]
...
<!--
    ...
    guides/integrate/sources/journald/honeycomb.md.erb
-->
