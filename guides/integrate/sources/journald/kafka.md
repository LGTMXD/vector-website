...
description: "A simple guide to send logs from Journald to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: kafka"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [Kafka][urls.kafka]
...
<!--
     ...
     guides/integrate/sources/journald/kafka.md.erb
-->
