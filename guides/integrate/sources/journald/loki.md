...
description: "A simple guide to send logs from Journald to Loki in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Loki Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: loki"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [Loki][urls.loki]
...
<!--
    ...
    guides/integrate/sources/journald/loki.md.erb
-->
