...
description: "A simple guide to send logs from Journald to Apache Pulsar in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [Apache Pulsar][urls.pulsar]
...
<!--
     ...
     guides/integrate/sources/journald/pulsar.md.erb
-->
