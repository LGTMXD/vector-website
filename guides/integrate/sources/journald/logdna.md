...
description: "A simple guide to send logs from Journald to LogDNA in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to LogDNA Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: logdna"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [LogDNA][urls.logdna]
...
<!--
     ...
     guides/integrate/sources/journald/logdna.md.erb
-->
