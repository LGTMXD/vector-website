...
description: "A simple guide to send logs from Journald to New Relic in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: new_relic_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [New Relic][urls.new_relic]
...
<!--
     ...
     guides/integrate/sources/journald/new_relic_logs.md.erb
-->
