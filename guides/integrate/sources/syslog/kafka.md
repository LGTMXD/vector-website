...
description: "A simple guide to send logs from Syslog to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: kafka"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [Kafka][urls.kafka]
...
<!--
     ...
     guides/integrate/sources/syslog/kafka.md.erb
-->
