...
cover_label: "Syslog to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [an HTTP endpoint][urls.http]
...
<!--
     ...
     guides/integrate/sources/syslog/http.md.erb
-->
