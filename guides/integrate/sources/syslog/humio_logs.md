...
description: "A simple guide to send logs from Syslog to Humio in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [Humio][urls.humio]
...
<!--
     ...
     guides/integrate/sources/syslog/humio_logs.md.erb
-->
