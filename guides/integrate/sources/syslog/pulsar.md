...
description: "A simple guide to send logs from Syslog to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: pulsar"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [Apache Pulsar][urls.pulsar]
...
<!--
    ...
    guides/integrate/sources/syslog/pulsar.md.erb
-->
