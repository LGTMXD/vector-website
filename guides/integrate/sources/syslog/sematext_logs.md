...
description: "A simple guide to send logs from Syslog to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to Sematext Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: sematext_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [Sematext][urls.sematext]
...
<!--
    ...
    guides/integrate/sources/syslog/sematext_logs.md.erb
-->
