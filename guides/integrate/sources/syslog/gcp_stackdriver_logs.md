...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [GCP Stackdriver][urls.gcp_stackdriver]
...
<!--
    ...
    guides/integrate/sources/syslog/gcp_stackdriver_logs.md.erb
-->
