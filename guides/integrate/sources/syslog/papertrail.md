...
description: "A simple guide to send logs from Syslog to Papertrail in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [Papertrail][urls.papertrail]
...
<!--
    ...
    guides/integrate/sources/syslog/papertrail.md.erb
-->
