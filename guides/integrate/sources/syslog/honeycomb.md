...
description: "A simple guide to send logs from Syslog to Honeycomb in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to Honeycomb Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [Honeycomb][urls.honeycomb]
...
<!--
    ...
    guides/integrate/sources/syslog/honeycomb.md.erb
-->
