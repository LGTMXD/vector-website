...
description: "A simple guide to send logs from Syslog to a TCP, UDP, or UDS socket in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to Socket Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: socket"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
     ...
     guides/integrate/sources/syslog/socket.md.erb
-->
