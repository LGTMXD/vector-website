...
description: "A simple guide to send logs from Splunk HEC to a Splunk HEC in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: splunk_hec"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [a Splunk HEC][urls.splunk_hec]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/splunk_hec.md.erb
-->
