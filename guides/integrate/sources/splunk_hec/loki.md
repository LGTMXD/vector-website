...
cover_label: "Splunk HEC to Loki Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: loki"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Loki][urls.loki]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/loki.md.erb
-->
