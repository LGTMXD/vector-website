...
description: "A simple guide to send logs from Splunk HEC to Sematext in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Sematext][urls.sematext]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/sematext_logs.md.erb
-->
