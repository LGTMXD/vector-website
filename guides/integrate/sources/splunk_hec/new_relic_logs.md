...
description: "A simple guide to send logs from Splunk HEC to New Relic in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: new_relic_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [New Relic][urls.new_relic]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/new_relic_logs.md.erb
-->
