...
cover_label: "Splunk HEC to Apache Pulsar Integration"
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Apache Pulsar][urls.pulsar]
...
<!--
    ...
    guides/integrate/sources/splunk_hec/pulsar.md.erb
-->
