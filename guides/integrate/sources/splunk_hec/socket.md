...
description: "A simple guide to send logs from Splunk HEC to a TCP, UDP, or UDS socket in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/socket.md.erb
-->
