...
description: "A simple guide to send logs from Splunk HEC to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Papertrail][urls.papertrail]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/papertrail.md.erb
-->
