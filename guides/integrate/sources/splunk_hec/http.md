...
description: "A simple guide to send logs from Splunk HEC to an HTTP endpoint in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [an HTTP endpoint][urls.http]
...
<!--
    ...
    guides/integrate/sources/splunk_hec/http.md.erb
-->
