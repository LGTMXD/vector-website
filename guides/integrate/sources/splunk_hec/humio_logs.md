...
description: "A simple guide to send logs from Splunk HEC to Humio in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Humio][urls.humio]
...
<!--
    ...
    guides/integrate/sources/splunk_hec/humio_logs.md.erb
-->
