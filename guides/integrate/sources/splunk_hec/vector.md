...
description: "A simple guide to send logs from Splunk HEC to another Vector instance in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to another Vector instance
...
<!--
     ...
     guides/integrate/sources/splunk_hec/vector.md.erb
-->
