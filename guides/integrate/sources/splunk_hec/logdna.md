...
description: "A simple guide to send logs from Splunk HEC to LogDNA in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to LogDNA Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: logdna"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [LogDNA][urls.logdna]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/logdna.md.erb
-->
