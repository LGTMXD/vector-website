...
description: "A simple guide to send logs from Splunk HEC to Kafka in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: kafka"]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/kafka.md.erb
-->
