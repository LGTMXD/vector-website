...
description: "A simple guide to send logs from Splunk HEC to Honeycomb in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to Honeycomb Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Honeycomb][urls.honeycomb]
...
<!--
     ...
     guides/integrate/sources/splunk_hec/honeycomb.md.erb
-->
