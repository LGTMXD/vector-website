...
description: "A simple guide to send logs from STDIN to a Splunk HEC in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: splunk_hec"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [a Splunk HEC][urls.splunk_hec]
...
<!--
     ...
     guides/integrate/sources/stdin/splunk_hec.md.erb
-->
