...
description: "A simple guide to send logs from STDIN to GCP Stackdriver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to GCP Stackdriver Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: gcp_stackdriver_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [GCP Stackdriver][urls.gcp_stackdriver]
...
<!--
     ...
     guides/integrate/sources/stdin/gcp_stackdriver_logs.md.erb
-->
