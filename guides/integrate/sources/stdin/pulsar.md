...
description: "A simple guide to send logs from STDIN to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: pulsar"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [Apache Pulsar][urls.pulsar]
...
<!--
    ...
    guides/integrate/sources/stdin/pulsar.md.erb
-->
