...
description: "A simple guide to send logs from STDIN to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to Humio Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: humio_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [Humio][urls.humio]
...
<!--
     ...
     guides/integrate/sources/stdin/humio_logs.md.erb
-->
