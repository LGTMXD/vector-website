...
cover_label: "STDIN to Socket Integration"
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
    ...
    guides/integrate/sources/stdin/socket.md.erb
-->
