...
cover_label: "STDIN to Honeycomb Integration"
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [Honeycomb][urls.honeycomb]
...
<!--
    ...
    guides/integrate/sources/stdin/honeycomb.md.erb
-->
