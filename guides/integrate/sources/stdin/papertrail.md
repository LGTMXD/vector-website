...
description: "A simple guide to send logs from STDIN to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [Papertrail][urls.papertrail]
...
<!--
    ...
    guides/integrate/sources/stdin/papertrail.md.erb
-->
