...
cover_label: "STDIN to Loki Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: loki"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [Loki][urls.loki]
...
<!--
    ...
    guides/integrate/sources/stdin/loki.md.erb
-->
