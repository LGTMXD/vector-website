...
description: "A simple guide to send logs from STDIN to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to InfluxDB Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: influxdb_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [InfluxDB][urls.influxdb]
...
<!--
     ...
     guides/integrate/sources/stdin/influxdb_logs.md.erb
-->
