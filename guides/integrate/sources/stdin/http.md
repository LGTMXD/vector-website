...
description: "A simple guide to send logs from STDIN to an HTTP endpoint in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [an HTTP endpoint][urls.http]
...
<!--
     ...
     guides/integrate/sources/stdin/http.md.erb
-->
