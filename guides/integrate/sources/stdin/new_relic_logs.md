...
description: "A simple guide to send logs from STDIN to New Relic in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: new_relic_logs"]
...
<!--
     ...
     guides/integrate/sources/stdin/new_relic_logs.md.erb
-->
