...
description: "A simple guide to send logs from STDIN to Sematext in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [Sematext][urls.sematext]
...
<!--
    ...
    guides/integrate/sources/stdin/sematext_logs.md.erb
-->
