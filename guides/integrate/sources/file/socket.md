...
description: "A simple guide to send logs from a file to a TCP, UDP, or UDS socket in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to Socket Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: socket"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
     ...
     guides/integrate/sources/file/socket.md.erb
-->
