...
description: "A simple guide to send logs from a file to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to Humio Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: humio_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [Humio][urls.humio]
...
<!--
     ...
     guides/integrate/sources/file/humio_logs.md.erb
-->
