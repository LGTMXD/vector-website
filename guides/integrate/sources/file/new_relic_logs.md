...
description: "A simple guide to send logs from a file to New Relic in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: new_relic_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [New Relic][urls.new_relic]
...
<!--
     ...
     guides/integrate/sources/file/new_relic_logs.md.erb
-->
