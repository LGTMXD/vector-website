...
description: "A simple guide to send logs from a file to Honeycomb in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to Honeycomb Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [Honeycomb][urls.honeycomb]
...
<!--
    ...
    guides/integrate/sources/file/honeycomb.md.erb
-->
