...
cover_label: "File to Sematext Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: sematext_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [Sematext][urls.sematext]
...
<!--
     ...
     guides/integrate/sources/file/sematext_logs.md.erb
-->
