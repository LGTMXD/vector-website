...
description: "A simple guide to send logs from a file to an HTTP endpoint in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [an HTTP endpoint][urls.http]
...
<!--
    ...
    guides/integrate/sources/file/http.md.erb
-->
