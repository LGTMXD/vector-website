...
description: "A simple guide to send logs from a file to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: pulsar"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [Apache Pulsar][urls.pulsar]
...
<!--
     ...
     guides/integrate/sources/file/pulsar.md.erb
-->
