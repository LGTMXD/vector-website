...
description: "A simple guide to send logs from a file to GCP Stackdriver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to GCP Stackdriver Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: gcp_stackdriver_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [GCP Stackdriver][urls.gcp_stackdriver]
...
<!--
     ...
     guides/integrate/sources/file/gcp_stackdriver_logs.md.erb
-->
