...
cover_label: "File to LogDNA Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: logdna"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [LogDNA][urls.logdna]
...
<!--
     ...
     guides/integrate/sources/file/logdna.md.erb
-->
