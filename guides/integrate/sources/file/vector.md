...
description: "A simple guide to send logs from a file to another Vector instance in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to Vector Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: vector"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to another Vector instance
...
<!--
     ...
     guides/integrate/sources/file/vector.md.erb
-->
