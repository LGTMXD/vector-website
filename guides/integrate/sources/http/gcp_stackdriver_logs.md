...
cover_label: "HTTP to GCP Stackdriver Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: gcp_stackdriver_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [GCP Stackdriver][urls.gcp_stackdriver]
...
<!--
    ...
    guides/integrate/sources/http/gcp_stackdriver_logs.md.erb
-->
