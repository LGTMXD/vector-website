...
description: "A simple guide to send logs from HTTP to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Humio Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: humio_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [Humio][urls.humio]
...
<!--
     ...
     guides/integrate/sources/http/humio_logs.md.erb
-->
