...
cover_label: "HTTP to New Relic Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: new_relic_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [New Relic][urls.new_relic]
...
<!--
     ...
     guides/integrate/sources/http/new_relic_logs.md.erb
-->
