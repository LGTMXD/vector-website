...
description: "A simple guide to send logs from HTTP to a Splunk HEC in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: splunk_hec"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [a Splunk HEC][urls.splunk_hec]
...
<!--
    ...
    guides/integrate/sources/http/splunk_hec.md.erb
-->
