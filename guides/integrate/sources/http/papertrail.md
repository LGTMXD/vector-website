...
description: "A simple guide to send logs from HTTP to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [Papertrail][urls.papertrail]
...
<!--
    ...
    guides/integrate/sources/http/papertrail.md.erb
-->
