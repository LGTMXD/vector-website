...
description: "A simple guide to send logs from HTTP to Loki in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Loki Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: loki"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [Loki][urls.loki]
...
<!--
     ...
     guides/integrate/sources/http/loki.md.erb
-->
