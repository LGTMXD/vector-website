...
description: "A simple guide to send logs from HTTP to another Vector instance in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to another Vector instance
...
<!--
     ...
     guides/integrate/sources/http/vector.md.erb
-->
