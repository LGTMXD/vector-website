...
description: "A simple guide to send logs from HTTP to Kafka in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [Kafka][urls.kafka]
...
<!--
     ...
     guides/integrate/sources/http/kafka.md.erb
-->
