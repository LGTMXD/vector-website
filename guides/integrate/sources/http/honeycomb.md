...
description: "A simple guide to send logs from HTTP to Honeycomb in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Honeycomb Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [Honeycomb][urls.honeycomb]
...
<!--
     ...
     guides/integrate/sources/http/honeycomb.md.erb
-->
