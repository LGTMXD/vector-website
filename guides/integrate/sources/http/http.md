...
description: "A simple guide to send logs from HTTP to an HTTP endpoint in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: http"]
...
<!--
     ...
     guides/integrate/sources/http/http.md.erb
-->
