...
description: "A simple guide to send logs from HTTP to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Sematext Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: sematext_logs"]
...
<!--
     ...
     guides/integrate/sources/http/sematext_logs.md.erb
-->
