...
description: "A simple guide to send logs from HTTP to LogDNA in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to LogDNA Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: logdna"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [LogDNA][urls.logdna]
...
<!--
    ...
    guides/integrate/sources/http/logdna.md.erb
-->
