...
description: "A simple guide to send logs from HTTP to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: pulsar"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [Apache Pulsar][urls.pulsar]
...
<!--
     ...
     guides/integrate/sources/http/pulsar.md.erb
-->
