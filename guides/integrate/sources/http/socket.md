...
description: "A simple guide to send logs from HTTP to a TCP, UDP, or UDS socket in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
     ...
     guides/integrate/sources/http/socket.md.erb
-->
