...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [a Splunk HEC][urls.splunk_hec]
...
<!--
     ...
     guides/integrate/sources/socket/splunk_hec.md.erb
-->
