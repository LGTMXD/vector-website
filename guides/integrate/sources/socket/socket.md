...
cover_label: "Socket to Socket Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: socket"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
    ...
    guides/integrate/sources/socket/socket.md.erb
-->
