...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to another Vector instance in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to Vector Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: vector"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to another Vector instance
...
<!--
    ...
    guides/integrate/sources/socket/vector.md.erb
-->
