...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to an HTTP endpoint in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to HTTP Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [an HTTP endpoint][urls.http]
...
<!--
     ...
     guides/integrate/sources/socket/http.md.erb
-->
