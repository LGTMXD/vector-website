...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to LogDNA in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to LogDNA Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: logdna"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [LogDNA][urls.logdna]
...
<!--
     ...
     guides/integrate/sources/socket/logdna.md.erb
-->
