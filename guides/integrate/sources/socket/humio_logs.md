...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to Humio Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: humio_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [Humio][urls.humio]
...
<!--
     ...
     guides/integrate/sources/socket/humio_logs.md.erb
-->
