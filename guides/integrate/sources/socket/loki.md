...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to Loki in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [Loki][urls.loki]
...
<!--
     ...
     guides/integrate/sources/socket/loki.md.erb
-->
