...
cover_label: "Socket to Kafka Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: kafka"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [Kafka][urls.kafka]
...
<!--
    ...
    guides/integrate/sources/socket/kafka.md.erb
-->
