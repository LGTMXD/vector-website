...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to Sematext Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: sematext_logs"]
...
<!--
    ...
    guides/integrate/sources/socket/sematext_logs.md.erb
-->
