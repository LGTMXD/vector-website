...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: pulsar"]
...
<!--
    ...
    guides/integrate/sources/socket/pulsar.md.erb
-->
