...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to InfluxDB Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: influxdb_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [InfluxDB][urls.influxdb]
...
<!--
    ...
    guides/integrate/sources/socket/influxdb_logs.md.erb
-->
