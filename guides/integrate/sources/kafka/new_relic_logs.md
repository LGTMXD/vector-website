...
description: "A simple guide to send logs from Kafka to New Relic in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to New Relic Logs Integration"
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [New Relic][urls.new_relic]
...
<!--
     ...
     guides/integrate/sources/kafka/new_relic_logs.md.erb
-->
