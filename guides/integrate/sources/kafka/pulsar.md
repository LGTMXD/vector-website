...
description: "A simple guide to send logs from Kafka to Apache Pulsar in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Apache Pulsar Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: pulsar"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [Apache Pulsar][urls.pulsar]
...
<!--
     ...
     guides/integrate/sources/kafka/pulsar.md.erb
-->
