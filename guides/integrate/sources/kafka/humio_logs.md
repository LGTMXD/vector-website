...
description: "A simple guide to send logs from Kafka to Humio in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Humio Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: humio_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [Humio][urls.humio]
...
<!--
     ...
     guides/integrate/sources/kafka/humio_logs.md.erb
-->
