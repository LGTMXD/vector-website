...
cover_label: "Kafka to Loki Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: loki"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [Loki][urls.loki]
...
<!--
     ...
     guides/integrate/sources/kafka/loki.md.erb
-->
