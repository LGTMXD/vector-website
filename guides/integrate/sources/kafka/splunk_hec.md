...
description: "A simple guide to send logs from Kafka to a Splunk HEC in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: splunk_hec"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [a Splunk HEC][urls.splunk_hec]
...
<!--
    ...
    guides/integrate/sources/kafka/splunk_hec.md.erb
-->
