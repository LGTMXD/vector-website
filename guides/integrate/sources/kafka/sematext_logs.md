...
description: "A simple guide to send logs from Kafka to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Sematext Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: sematext_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [Sematext][urls.sematext]
...
<!--
    ...
    guides/integrate/sources/kafka/sematext_logs.md.erb
-->
