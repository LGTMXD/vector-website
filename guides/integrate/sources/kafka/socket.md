...
description: "A simple guide to send logs from Kafka to a TCP, UDP, or UDS socket in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Socket Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: socket"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
    ...
    guides/integrate/sources/kafka/socket.md.erb
-->
