...
description: "A simple guide to send logs from Kafka to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to InfluxDB Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: influxdb_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [InfluxDB][urls.influxdb]
...
<!--
    ...
    guides/integrate/sources/kafka/influxdb_logs.md.erb
-->
