...
cover_label: "Kafka to Honeycomb Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [Honeycomb][urls.honeycomb]
...
<!--
     ...
     guides/integrate/sources/kafka/honeycomb.md.erb
-->
