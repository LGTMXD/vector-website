...
description: "A simple guide to send logs from Kafka to an HTTP endpoint in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [an HTTP endpoint][urls.http]
...
<!--
     ...
     guides/integrate/sources/kafka/http.md.erb
-->
