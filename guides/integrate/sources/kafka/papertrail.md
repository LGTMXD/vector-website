...
description: "A simple guide to send logs from Kafka to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Papertrail Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [Papertrail][urls.papertrail]
...
<!--
     ...
     guides/integrate/sources/kafka/papertrail.md.erb
-->
