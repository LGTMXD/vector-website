...
description: "A simple guide to send logs to LogDNA in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs to [LogDNA][urls.logdna]
...
<!--
     ...
     guides/integrate/sinks/logdna.md.erb
-->
