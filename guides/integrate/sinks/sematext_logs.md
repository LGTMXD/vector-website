...
description: "A simple guide to send logs to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Sematext Logs Integration"
tags: ["type: tutorial","domain: sinks","sink: sematext_logs"]
...
Fear not! In this guide we'll show you how to send send logs to [Sematext][urls.sematext]
...
<!--
    ...
    guides/integrate/sinks/sematext_logs.md.erb
-->
