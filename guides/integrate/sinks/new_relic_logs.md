...
cover_label: "New Relic Logs Integration"
tags: ["type: tutorial","domain: sinks","sink: new_relic_logs"]
...
Fear not! In this guide we'll show you how to send send logs to [New Relic][urls.new_relic]
...
<!--
     ...
     guides/integrate/sinks/new_relic_logs.md.erb
-->
