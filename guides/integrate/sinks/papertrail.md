...
description: "A simple guide to send logs to Papertrail in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Papertrail Integration"
tags: ["type: tutorial","domain: sinks","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs to [Papertrail][urls.papertrail]
...
<!--
    ...
    guides/integrate/sinks/papertrail.md.erb
-->
