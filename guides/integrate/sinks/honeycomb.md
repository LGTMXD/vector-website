...
cover_label: "Honeycomb Integration"
tags: ["type: tutorial","domain: sinks","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs to [Honeycomb][urls.honeycomb]
...
<!--
    ...
    guides/integrate/sinks/honeycomb.md.erb
-->
