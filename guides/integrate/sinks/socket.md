...
description: "A simple guide to send logs to a TCP, UDP, or UDS socket in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket Integration"
tags: ["type: tutorial","domain: sinks","sink: socket"]
...
Fear not! In this guide we'll show you how to send send logs to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
    ...
    guides/integrate/sinks/socket.md.erb
-->
