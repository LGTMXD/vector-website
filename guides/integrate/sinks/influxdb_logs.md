...
description: "A simple guide to send logs to InfluxDB in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "InfluxDB Logs Integration"
tags: ["type: tutorial","domain: sinks","sink: influxdb_logs"]
...
Fear not! In this guide we'll show you how to send send logs to [InfluxDB][urls.influxdb]
...
<!--
     ...
     guides/integrate/sinks/influxdb_logs.md.erb
-->
