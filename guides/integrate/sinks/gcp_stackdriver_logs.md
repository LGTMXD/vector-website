...
description: "A simple guide to send logs to GCP Stackdriver in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "GCP Stackdriver Logs Integration"
tags: ["type: tutorial","domain: sinks","sink: gcp_stackdriver_logs"]
...
Fear not! In this guide we'll show you how to send send logs to [GCP Stackdriver][urls.gcp_stackdriver]
...
<!--
     ...
     guides/integrate/sinks/gcp_stackdriver_logs.md.erb
-->
