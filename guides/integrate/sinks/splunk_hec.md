...
description: "A simple guide to send logs to a Splunk HEC in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC Integration"
tags: ["type: tutorial","domain: sinks","sink: splunk_hec"]
...
<!--
     ...
     guides/integrate/sinks/splunk_hec.md.erb
-->
