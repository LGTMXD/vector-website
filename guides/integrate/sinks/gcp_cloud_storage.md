...
cover_label: "GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sinks","sink: gcp_cloud_storage"]
...
Fear not! In this guide we'll show you how to send send logs to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
...
<!--
    ...
    guides/integrate/sinks/gcp_cloud_storage.md.erb
-->
