...
description: "A simple guide to send logs to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "GCP PubSub Integration"
tags: ["type: tutorial","domain: sinks","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs to [GCP PubSub][urls.gcp_pubsub]
...
<!--
    ...
    guides/integrate/sinks/gcp_pubsub.md.erb
-->
