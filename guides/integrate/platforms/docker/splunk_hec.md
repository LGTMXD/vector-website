...
description: "A simple guide to send logs from Docker to a Splunk HEC in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to Splunk HEC Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: splunk_hec"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [a Splunk HEC][urls.splunk_hec]
...
<!--
    ...
    guides/integrate/platforms/docker/splunk_hec.md.erb
-->
