...
description: "A simple guide to send logs from Docker to Sematext in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to Sematext Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: sematext_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [Sematext][urls.sematext]
...
<!--
     ...
     guides/integrate/platforms/docker/sematext_logs.md.erb
-->
