...
description: "A simple guide to send logs from Docker to Loki in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to Loki Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: loki"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [Loki][urls.loki]
...
<!--
     ...
     guides/integrate/platforms/docker/loki.md.erb
-->
