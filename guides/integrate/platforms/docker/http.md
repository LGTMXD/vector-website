...
cover_label: "Docker to HTTP Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: http"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [an HTTP endpoint][urls.http]
...
<!--
    ...
    guides/integrate/platforms/docker/http.md.erb
-->
