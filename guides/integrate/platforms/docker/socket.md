...
cover_label: "Docker to Socket Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: socket"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [a TCP, UDP, or UDS socket][urls.socket]
...
<!--
     ...
     guides/integrate/platforms/docker/socket.md.erb
-->
