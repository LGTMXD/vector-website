...
cover_label: "Docker to InfluxDB Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: influxdb_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [InfluxDB][urls.influxdb]
...
<!--
     ...
     guides/integrate/platforms/docker/influxdb_logs.md.erb
-->
