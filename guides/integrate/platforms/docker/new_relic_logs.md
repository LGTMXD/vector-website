...
description: "A simple guide to send logs from Docker to New Relic in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to New Relic Logs Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: new_relic_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [New Relic][urls.new_relic]
...
<!--
     ...
     guides/integrate/platforms/docker/new_relic_logs.md.erb
-->
