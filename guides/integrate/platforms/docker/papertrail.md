...
cover_label: "Docker to Papertrail Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: papertrail"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [Papertrail][urls.papertrail]
...
<!--
     ...
     guides/integrate/platforms/docker/papertrail.md.erb
-->
