...
description: "A simple guide to send logs from Docker to Honeycomb in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to Honeycomb Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: honeycomb"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [Honeycomb][urls.honeycomb]
...
<!--
     ...
     guides/integrate/platforms/docker/honeycomb.md.erb
-->
